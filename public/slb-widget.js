  ...
  if(jq.readyState) {
    ...
    var temp = '<div id="widget-header" class="widget-header loaded" style="background-color: rgb(92, 145, 62); bottom: 0px; overflow: hidden; line-height: 1px; height: 20px; border-top-left-radius: 5px; border-top-right-radius: 5px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; list-style: none; padding: 15px 0px 0px 5px; font-size: 11px; text-rendering: optimizelegibility; color: rgb(255, 255, 255); font-family: "lucida grande", tahoma, verdana, arial, sans-serif; z-index: 2147483638; text-align: left; right: 0px; margin-right: 6px;">    <span style="padding-left:15px;font-family:lucida grande, tahoma, verdana, arial, sans-serif;font-weight:bold;font-size:11px;vertical-align: middle;display: inline;">Report Issue</span>    </div>';
    temp += '<div id="widget-body" style = ""><form accept-charset="UTF-8" action="#" class="new_widget" id="new_widget" method="post"><div style="margin-left:20px;padding:0;display:inline"><input name="utf8" type="hidden" value="✓"></div>   <div class="field">    <label for="widget_email_id">Email</label> <input id="widget_email_id" name="widget[email_id]" size="30" style="width:95%" type="text">  </div>  <div class="field">    <label for="widget_name">Name</label>    <input id="widget_name" name="widget[name]" size="30" style="width:95%" type="text">  </div>  <div class="field">    <label for="widget_subject">Subject</label>    <input id="widget_subject" name="widget[subject]" size="30" style="width:95%" type="text">  </div> <div class="field"> <label for="widget_message">Message</label>    <textarea cols="40" id="widget_message" name="widget[message]" rows="3" style="width:90%"></textarea>  <input type="checkbox" id="attach_screenshot" name="screenshot">Attach Screenshot</input><br></div>  <div class="actions">    <input name="commit" type="submit" value="Report Issue">  </div> </form></div>'
